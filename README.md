...
<body>
    <div class="container col-12">
        <div class="container bg-black col-10 mt-4 rounded" >
            <div class="row">
 ...
 <div class="row mt-3">
            ...
            <input type="button" name="" class="col-12 rounded-5  cl  " id="back" onclick="back()" placeholder="button" value="Del">
             ...
             <div class="row mt-3">
                 <div class="col-3 bg-secondary rounded">
                    <input type="button" name="" class="col-12 rounded-5  cl"  class="col-12 rounded-5  cl"  id="seven" onclick="seven1()"  placeholder="button" value="7">
                </div>
                <div class="col-3 bg-secondary rounded">
